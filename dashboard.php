...
<head>
	...
	<title> Carol Bakers | Admin Dashboard</title>
...
?>
											...
											<a href="manage-cake.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>
	...
	?>
													...
													<div class="stat-panel-number h1 "><?php echo htmlentities($employeedetail);?></div>
